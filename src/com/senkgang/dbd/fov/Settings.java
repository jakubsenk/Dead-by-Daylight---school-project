...
public class Settings
{
	...
	private IntegerProperty scanLineCount = new SimpleIntegerProperty(500);
	...
	public final Color getSceneColor()
	{
		return this.sceneColorProperty().get();
	}

	public final void setSceneColor(final Color sceneColor)
	{
